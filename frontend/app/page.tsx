...
export default function HomePage() {
  ...
  async function handleLaunchSimulation() {
    try {
      ...
      setStatus("正在启动 scene_01_intro 到 scene_04_group_dinner runtime...");
  ...
  return (
    <main className="marketing-shell">
      <section className="hero-card">
        <div className="hero-copy">
          ...
          <p className="hero-body">
            ...
            的人格，再启动一个连续运行的 runtime，让 scene_01_intro、scene_02_free_talk、scene_03_random_date 和 scene_04_group_dinner
            在同一局里形成真实的多人多轮关系图。
          </p>
          <div className="hero-metrics">
            ...
            <article>
              <strong>四场连续 runtime</strong>
              <span>scene_01_intro 建立张力，scene_02_free_talk 拉开偏好，scene_03_random_date 触发意外连接，scene_04_group_dinner 放大多人竞争。</span>
            </article>
            <article>
      ...
      <section className="content-card">
        ...
        <p className="card-intro">选择最多 2 张，影响四场 scene 的整体互动倾向。</p>
